...
CNNdata<-read.csv("2014_plants_snail_xy_data.csv") ###had pre here - check redundancies??
...
```{r} 
###need to revise paths
#These text files contain the results of the manual validity check described in the Methods section

print('Batis:')
CNNdata<-df.reviser('~/Desktop/SEM_submodel_scripts/BatisCheck.txt',preCNNdata,12)  #use column 12 for Batis (this is all dataframe dependent) ###redundancy here???
print('Spartina:')
