...
```{r}
PAjuncNeff<-as.numeric(N.eff(PA.junc.Moran$estimate[1],length(junc.hab[,1]))) #calculate n' for each model
...
```{r}
junc_coef<-range.std.coef(juncPAmod1,juncPmod1,CNNdata)
```
