...
```{r}
PAbatisNeff<-as.numeric(N.eff(PA.batis.Moran$estimate[1],length(batis.hab[,1]))) #calculate n' for each model
...
```{r}
batiscoef<-range.std.coef(batisPAmod1,batisPmod1,CNNdata)
```
