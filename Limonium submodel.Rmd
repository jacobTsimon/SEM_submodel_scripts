...
```{r}
PAlimoNeff<-as.numeric(N.eff(PA.limo.Moran$estimate[1],length(limo.hab[,1]))) #calculate n' for each model
...
```{r}
limo_coef<-range.std.coef(limoPAmod1,limoPmod3,CNNdata)
```
